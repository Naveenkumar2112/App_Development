...
import img1 from '../images/—Pngtree—cartoon customer service staff_2879525.png';
  ...
  return (
    <Box sx={{ display: 'flex' }}>
      ...
      <Main open={open}>
        ...
        <Link to="/list" className="link"><div className="feature-box">
           <img src={img1} style={{height:'120px'}}></img> 
          <h2 style={{marginTop:"0px"}}>Product Details</h2>
          <h3>100</h3>
        </div></Link>
        <div className="feature-box">
         <img src={img1} style={{height:'120px'}}></img> 
          <h2 style={{marginTop:"0px"}}>Customer Details</h2>
          <h3>200</h3>
        </div>
        <div className="feature-box">
         <img src={img1} style={{height:'120px'}}></img> 
          <h2 style={{marginTop:"0px"}}>Transaction Details</h2>
          <h3>Payments</h3>
        </div>
      </div>
