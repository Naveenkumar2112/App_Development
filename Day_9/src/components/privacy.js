...
function PrivacyPolicy() {
  return (
    ...
    <div className="privacy-policy">
      ...
      {/* Include the list of Sensitive Personal Data or Information here as per the original content. */}
      ...
      {/* Include the rest of the content sections (6 to 9) in a similar format. */}
    </div>
    </div>
  );
}
